...
char *plantName;
char *plantSpecies;
char *wateringSchedule;
char *sunlightRequirements;
char *searchName;
int isRunning = 1;
...
int main() {
    ...
    plantName = (char *)malloc(50 * sizeof(char));
    plantSpecies = (char *)malloc(50 * sizeof(char));
    wateringSchedule = (char *)malloc(50 * sizeof(char));
    sunlightRequirements = (char *)malloc(50 * sizeof(char));
    searchName = (char *)malloc(50 * sizeof(char));
